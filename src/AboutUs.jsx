...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Wild Meadow Plant Nursery, where roots travel well!</p>
      <p className="about-us-content">
        At Wild Meadow Plant Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Wild Meadow Plant Nursery today and experience the 
